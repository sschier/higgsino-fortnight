...
def MakeSignalLegend(bkgndHists, signalHists, region):
    ...
    #l = ROOT.TLegend(0.2, 0.65, 0.55, 0.81) #xMin, yMin, xMax, yMax
    l = ROOT.TLegend(0.65, 0.73, 0.95, 0.95)
    l.SetNColumns(2)
...
def main(argv):
    ...
    variables1 = ['mll']
    variables2 = ['mll', 'METoverHt','Lep1Pt','Lep2Pt']
    variables3 = ['mll', 'mll2', 'METoverHt','Lep1Pt','Lep2Pt']
    ...
    #for v in var_list:
        ...
        #CMS_EWSR_hm_path = 'EWsignal/EWsignal_highmet/h_EWsignal_highmet_%s' %v
        #CMS_EWSR_lm_path = 'EWsignal/EWsignal_lowmet/h_EWsignal_lowmet_%s' %v
        #TODO: Add all N-1 paths
    ...
    if args.test: print "running plot()"
        ...
        #plotSR(CMS_EWSR_hm_path, 'EWhighmet',v, args.indir, args.test)
        #plotSR(CMS_EWSR_lm_path, 'EWlowmet',v, args.indir, args.test)
        #TODO: Plot all N-1
        #plotCR(CMS_DYCR_hm_path, 'DYCRhm',v, args.indir, args.test)
        #plotCR(CMS_DYCR_lm_path, 'DYCRlm',v, args.indir, args.test)
        #plotCR(CMS_ttCR_hm_path, 'ttCRhm',v, args.indir, args.test)
        #plotCR(CMS_ttCR_lm_path, 'ttCRlm',v, args.indir, args.test)
