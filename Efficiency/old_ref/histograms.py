...
class validationhists:
    def __init__(self, tag, topdir, isdata, treetype, DSID, sumWHist, detaillevel=99):
        ...
        self.hists['MTauTau']=ROOT.TH1F("h_"+tag+"_MTauTau",tag+"_MTauTau; M_{#Tau#Tau}; Events/(25 GeV) ",80, -500., 1500.)
...
class histcollection:
    ...
    def addvalidationcollection(self, tag):
        self.newdir.cd()
        self.collections[tag]=validationhists(self.tag+"_"+tag, self.newdir, self.isdata, self.tree, self.DSID, self.sumWHist, self.detaillevel)
        self.topdir.cd()
