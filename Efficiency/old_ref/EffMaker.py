...
def baseLeptonEE(event, hc, CutsDict):
    if( CutsDict["2BaseLep"] == True and CutsDict["eeEvent"] == True and CutsDict["EleFiducial"] == True and CutsDict["opSign"] == True ):
        hc.fill(event, "skim")
        if( CutsDict["10mll"] ):
            hc.fill(event, "tail")
        return True
...
def baseLeptonMM(event, hc, CutsDict):
    if( CutsDict["2BaseLep"] == True and CutsDict["mumuEvent"] == True and CutsDict["MuFiducial"] == True and CutsDict["opSign"] == True ):
        hc.fill(event, "skim")
        if( CutsDict["10mll"] ):
            hc.fill(event, "tail")
        return True
...
def baseLeptonEM(event, hc, CutsDict):
    if( CutsDict["2BaseLep"] == True and CutsDict["mumuEvent"] == False and CutsDict["eeEvent"] == False and CutsDict["opSign"] == True ):
        hc.fill(event, "skim")
        return True
    else: return False
#======================================================================
def signalLeptonEE(event, hc, CutsDict):
    if( CutsDict["2SigLep"] == True and CutsDict["eeEvent"] == True and CutsDict["EleFiducial"] == True and CutsDict["opSign"] == True ):
        hc.fill(event, "skim")
        return True
    else: return False
#======================================================================
def signalLeptonMM(event, hc, CutsDict):
    #if( CutsDict["Mu1PseudoSignal"] and CutsDict["Mu2PseudoSignal"], and CutsDict["mumuEvent"] and CutsDict["MuFiducial"] and CutsDict["opSign"] ):
    if( CutsDict["2SigLep"] and CutsDict["mumuEvent"] and CutsDict["MuFiducial"] and CutsDict["opSign"] ):
        hc.fill(event, "skim")
        return True
    else: return False
#======================================================================
def signalLeptonEM(event, hc, CutsDict):
    if( CutsDict["2SigLep"] == True and CutsDict["mumuEvent"] == False and CutsDict["eeEvent"] == False and CutsDict["opSign"] == True ):
        hc.fill(event, "skim")
        return True
    else: return False
#======================================================================
...
def analyze(infile, weightfile, tree, DSID, data, signal, outfile, debug, region):
    ...
    t.SetBranchStatus("lep1IsoFixedCutTightTrackOnly",1) 
    ...
    t.SetBranchStatus("lep2IsoFixedCutTightTrackOnly",1) 
    ...
    t.SetBranchStatus("lep3IsoFixedCutTightTrackOnly",1) 
    ...
    t.SetBranchStatus("lep4IsoFixedCutTightTrackOnly",1) 
    ...
    for event in t:
        ...
        lep1D0Sig = event.lep1D0Sig
        lep2D0Sig = event.lep2D0Sig
        lep1Z0SinTheta = event.lep1Z0SinTheta
        lep2Z0SinTheta = event.lep2Z0SinTheta
        lep1IsoFixedCutTightTrackOnly = event.lep1IsoFixedCutTightTrackOnly
        lep2IsoFixedCutTightTrackOnly = event.lep2IsoFixedCutTightTrackOnly
        ...
        if( lep1Eta < 2.47 and lep2Eta < 2.47 and lep1Pt > 4.5 and lep2Pt > 4.5 ):
            Cuts["EleFiducial"] = True
        else: Cuts["EleFiducial"] = False

        if( lep1Eta < 2.5 and lep2Eta < 2.5 and lep1Pt > 4 and lep2Pt > 4 ):
            Cuts["MuFiducial"] = True
        else: Cuts["MuFiducial"] = False

        if( abs(lep1D0Sig) < 3 and abs(lep1Z0SinTheta) < 0.5 and lep1IsoFixedCutTightTrackOnly):
            Cuts["Mu1PseudoSignal"] = True
        else: Cuts["Mu1PseudoSignal"] = False

        if( abs(lep2D0Sig) < 3 and abs(lep2Z0SinTheta) < 0.5 and lep2IsoFixedCutTightTrackOnly):
            Cuts["Mu2PseudoSignal"] = True
        else: Cuts["Mu2PseudoSignal"] = False
