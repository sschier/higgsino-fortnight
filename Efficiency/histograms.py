...
class SOWrecohists:
    def __init__(self, tag, topdir, detaillevel=99):
        ...
        self.hists['sumOfWeights']=ROOT.TH1F("h_"+tag+"_sumOfWeights",tag+"_sumOfWeights; DSID; Total Weight ",1100, 393100, 394199)
        self.hists['sumOfWeightsC1C1']=ROOT.TH1F("h_"+tag+"_sumOfWeightsC1C1",tag+"_sumOfWeights; DSID; Total Weight ",1100, 393100, 394199)
        self.hists['sumOfWeightsN2C1m']=ROOT.TH1F("h_"+tag+"_sumOfWeightsN2C1m",tag+"_sumOfWeights; DSID; Total Weight ",1100, 393100, 394199)
        self.hists['sumOfWeightsN2C1p']=ROOT.TH1F("h_"+tag+"_sumOfWeightsN2C1p",tag+"_sumOfWeights; DSID; Total Weight ",1100, 393100, 394199)
        self.hists['sumOfWeightsN2N1']=ROOT.TH1F("h_"+tag+"_sumOfWeightsN2N1",tag+"_sumOfWeights; DSID; Total Weight ",1100, 393100, 394199)
    ...
    def fill(self, event):
        ...
        DSID = event.DatasetNumber
        totalWeight = float(eventWeight) #TODO: NO TRIGGER WEIGHT!!

        self.hists["sumOfWeights"].Fill(int(DSID), totalWeight)
        if( event.FS == 112 ): self.hists["sumOfWeightsN2N1"].Fill(int(DSID), totalWeight)
        elif( event.FS == 125 ): self.hists["sumOfWeightsN2C1p"].Fill(int(DSID), totalWeight)
        elif( event.FS == 127 ): self.hists["sumOfWeightsN2C1m"].Fill(int(DSID), totalWeight)
        elif( event.FS == 157 ): self.hists["sumOfWeightsC1C1"].Fill(int(DSID), totalWeight)
        #if DSID == 393501:
        #    print event.xsec
        #    self.hists["sumOfWeights"].Fill(int(DSID), totalWeight)
#------------------------------------------------------------------
...
class histcollection:
    def __init__(self, tag, topdir, debug, detaillevel=99):
        self.tag=tag
        self.topdir=topdir
        if debug: 
            print "topdir"
    ...
    def addtruthcollection(self, tag):
        self.newdir.cd()
        self.collections[tag]=SOWtruthhists(self.tag+"_"+tag, self.newdir, self.detaillevel)
        self.topdir.cd()

    def addrecocollection(self, tag):
        self.newdir.cd()
        self.collections[tag]=SOWrecohists(self.tag+"_"+tag, self.newdir, self.detaillevel)
        self.topdir.cd()
