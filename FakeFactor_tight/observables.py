...
class observable:
    ...
    def getIDelectronList(self):
        ...
        return IDelectronList

    def getAntiIDelectronList(self):
        AIDelectronList = []
        for x in xrange(self.getNBaseel()):
            ...
            #if( self.baseel_idTight[x] == 0 or self.baseel_isoGradientLoose[x] == 0 or abs(self.baseel_d0sig[x]) >= 5. ): #or abs(self.baseel_z0sinTheta[x]) >= 0.5 ):
