...
_loader_path = os.path.join(_path_of_this_file, 'loader.C')
ROOT.gROOT.ProcessLine('.L %s+' % _loader_path)
...
#    ROOT.TTree.SetMaxTreeSize(100*1000000000)  # (100 GB)
    ...
    for outfile_name, infile_names, counter, counter_weighted in zip(outfile_names, infile_names_list, counters, counters_weighted):
        ...
        for tree_name in tree_names_to_keep:
            ...
            if tree_out:
                ...
                print "Did not save %s, no trees found" % tree_name
        f_out.Close()
    print 'Done.'
