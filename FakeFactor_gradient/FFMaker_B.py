...
def analyze(infile, tree, data, signal, outfile, debug, region, variation, AIDvariation):
    ...
    AID3.addantiidcollection("FFAIDb0")
    AID3.addantiidcollection("FFAIDSRb0")
    AID3.addantiidcollection("FFAIDb1")
    AID3.addantiidcollection("FFAIDSRb1")
    ...
    AID13.addantiidcollection("FFAIDb0")
    AID13.addantiidcollection("FFAIDSRb0")
    AID13.addantiidcollection("FFAIDb1")
    AID13.addantiidcollection("FFAIDSRb1")
