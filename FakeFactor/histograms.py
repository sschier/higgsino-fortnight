...
#------------------------------------------------------------------
class antiidhists:
    def __init__(self, tag, topdir, isdata, treetype, sumWHist, detaillevel=99):
        self.tag=tag
        self.topdir=topdir
        self.isdata = isdata
        self.tree = treetype
...
class histcollection:
    def __init__(self, tag, topdir, debug, isdata, treetype, sumWHist, detaillevel=99):
        self.tag=tag
        self.topdir=topdir
        if debug: 
            print "topdir"
    ...
    def addantiidcollection(self, tag):
        self.newdir.cd()
        self.collections[tag]=antiidhists(self.tag+"_"+tag, self.newdir, self.isdata, self.tree, self.sumWHist, self.detaillevel)
        self.topdir.cd()

    def addidcollection(self, tag):
        self.newdir.cd()
        self.collections[tag]=idhists(self.tag+"_"+tag, self.newdir, self.isdata, self.tree, self.sumWHist, self.detaillevel)
        self.topdir.cd()

    def addfakecollection(self, tag):
        self.newdir.cd()
        self.collections[tag]=fakehists(self.tag+"_"+tag, self.newdir, self.isdata, self.tree, self.sumWHist, self.detaillevel)
        self.topdir.cd()
