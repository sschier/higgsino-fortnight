...
base_dir = '/export/share/data/sschier/FakeLepton/skims/'
arg_template = ' --input=%s --tree=wjets_22 --outfile=outputHist_wjets.root'
input_files = glob.glob(base_dir+'wjets_skims/*')
...
input_files = glob.glob(base_dir+'zjets_skims/*')
...
input_files = glob.glob(base_dir+'singletop_skims/*')
...
input_files = glob.glob(base_dir+'ttbar_skims/*')
...
input_files = glob.glob(base_dir+'data16_skims/*')
...
input_files = glob.glob(base_dir+'data15_skims/*')
