...
def FFIDSR(event, hc, IDCuts, muList, Z0list, D0list, variation):
    ...
    for CutsDict, mu, z0, d0 in zip(IDCuts, muList, Z0list, D0list):
        ...
        if( ((CutsDict["HLT_mu4"] and CutsDict["mu5"]) or (CutsDict["HLT_mu10"] and CutsDict["mu10"]) or (CutsDict["HLT_mu14"] and CutsDict["mu15"]) or (CutsDict["HLT_mu18"] and CutsDict["mu20"])) and CutsDict["j75"] ):
