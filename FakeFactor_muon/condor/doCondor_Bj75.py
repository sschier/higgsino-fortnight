...
condor.run(exe, arg_template, input_files, dirname='%s_bjetBinsj75/ttbar' % st, nfiles=1)
...
condor.run(exe, arg_template, input_files, dirname='%s_bjetBinsj75/wjets' % st, nfiles=1)
...
condor.run(exe, arg_template, input_files, dirname='%s_bjetBinsj75/zjets' % st, nfiles=1)
...
condor.run(exe, arg_template, input_files, dirname='%s_bjetBinsj75/singletop' % st, nfiles=1)
...
condor.run(exe, arg_template, input_files, dirname='%s_bjetBinsj75/data16' % st, nfiles=1)
...
condor.run(exe, arg_template, input_files, dirname='%s_bjetBinsj75/data15' % st, nfiles=1)
