...
condor.run(exe, arg_template, input_files, dirname='%s_bjetBins/ttbar' % st, nfiles=1)
...
condor.run(exe, arg_template, input_files, dirname='%s_bjetBins/wjets' % st, nfiles=1)
...
condor.run(exe, arg_template, input_files, dirname='%s_bjetBins/zjets' % st, nfiles=1)
...
condor.run(exe, arg_template, input_files, dirname='%s_bjetBins/singletop' % st, nfiles=1)
...
condor.run(exe, arg_template, input_files, dirname='%s_bjetBins/data16' % st, nfiles=1)
...
condor.run(exe, arg_template, input_files, dirname='%s_bjetBins/data15' % st, nfiles=1)
